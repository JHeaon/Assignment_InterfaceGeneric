...
@Service
public class ParcelDeliveryServiceImpl extends ParcelDeliveryService{
    private final DeliveryRepository deliveryRepository;
    private final ParcelRepository parcelRepository;

    public ParcelDeliveryServiceImpl(DeliveryRepository deliveryRepository, ParcelRepository parcelRepository) {
        this.deliveryRepository = deliveryRepository;
        this.parcelRepository = parcelRepository;
    }

    @Override
    public Delivery delivery(Long parcelId) {
    ...
    @Override
    public List<Parcel> getAllObject() {
